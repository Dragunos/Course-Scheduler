...
public class QuanTriDanhSachLopAppService
		implements QuanTriDanhSachLopUseCase
{
	private final DanhSachLopRepositoryPort repo;

	private final ImportDanhSachLopUseCase importUseCase;

	public QuanTriDanhSachLopAppService(
			DanhSachLopRepositoryPort repo,
	...
	public List<DanhSachLopDto> listDanhSachCongKhai()
	{
		try {
			...
			throw new PersistenceException("Cannot load public lists", ex);
		}
	}
			...
			UpdateDanhSachLopRequestDto request)
	{
		...
		try {
			...
			throw new PersistenceException("Cannot update", ex);
		}
	}
	...
	public void deleteDanhSach(Long danhSachId)
	{
		try {
			...
			throw new PersistenceException("Cannot delete", ex);
		}
	}
